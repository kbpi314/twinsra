...
df = read.table('/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/outputs/jobs02/alpha_MTX.tsv', 
...
for (i in 1:1) {
  ...
  # plot boxplot
  p <- ggplot(data = df, aes(x = MTX, y = Shannon_Diff, fill = MTX)) +
    ...
    xlab(NULL) +
    ylab("Intra-TwinPair Shannnon Entropy Difference") +#, "Shannon Entropy")) +
    bkg
