...
df = read.table('/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/outputs/jobs02/df_corr.tsv', 
...
for (i in 1:4) {
  ...
  p <- ggplot(df, aes_string(x='shannon_entropy', y=paste(a))) + 
    geom_point()+
  ...
  filename_box.plot = paste(a, "clean_corr.plot.pdf", sep = "_")  
