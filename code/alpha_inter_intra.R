...
# save.image(file="/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/outputs/jobs20/alpha_inter_intra_data.RData")
...
# read in df
df = read.table('/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/outputs/jobs02/intra_alpha_dist.tsv', 
...
for (i in 1:1) {
  ...
  filename_box.plot = paste("Alpha", "all_box.plot.pdf", sep = "_")  
