...
load(file="/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/code/RA.twins_16S_metabolites.RData")

# Save R script
# Do this step prior to closing R
save.image(file="/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/code/RA.twins_16S_metabolites.RData")
...
# directory
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/8_metabolites/"

# read in data table
d <- read.table(file = paste(dir, "metabolites.txt", sep = ""),
...
stats.table.all <- matrix(data = NA, nrow = 11, ncol = 3)
colnames(stats.table.all) <- c("metabolite", "wilcoxon", "ttest")

stats.table.clean <- matrix(data = NA, nrow = 11, ncol = 3)
colnames(stats.table.clean) <- c("metabolite", "wilcoxon", "ttest")
...
# save
ft.all = paste(dir, "metabolites_stats_all.csv", sep = "")
write.csv(file = ft.all, stats.table.all)

ft.clean = paste(dir, "metabolites_stats_clean.csv", sep = "")
...
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/8_metabolites/all/"
...
for (i in 1:11) {
  ...
  p <- ggplot(data = d.final, aes(x = Diagnosis, y = Abundance, fill = Diagnosis)) +
    ...
    xlab(NULL) +
    ylab(paste(m, "abundance (nmol/mg)")) +
    bkg
...
# directory for storing files
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/8_metabolites/clean/"
