...
load(file="/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/code/RA.twins_16S_acpa_plasma.RData")

# Save R script
# Do this step prior to closing R
save.image(file="/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/code/RA.twins_16S_acpa_plasma.RData")
...
### ACPA plasma statistics ###

# directory
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/11_acpa_plasma/"

# read in data table
d <- read.table(file = paste(dir, "acpa_plasma.txt", sep = ""),
...
stats.table.all <- matrix(data = NA, nrow = 117, ncol = 3)
colnames(stats.table.all) <- c("acpa plasma analyte", "wilcoxon", "ttest")

stats.table.clean <- matrix(data = NA, nrow = 117, ncol = 3)
colnames(stats.table.clean) <- c("acpa plasma analyte", "wilcoxon", "ttest")
...
# save
ft.all = paste(dir, "acpa_plasma_stats_all.csv", sep = "")
write.csv(file = ft.all, stats.table.all)

ft.clean = paste(dir, "acpa_plasma_stats_clean.csv", sep = "")
...
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/11_acpa_plasma/all/"
...
# directory for storing files
dir = "/Users/KevinBu/Desktop/clemente_lab/Projects/twinsra/inputs/RA_twins/16S/jobs/11_acpa_plasma/clean/"
...
### ACPA plasma statistics - revised ###
...
# create tables for storing wilcoxon and ttest results
stats.table.clean <- matrix(data = NA, nrow = 117, ncol = 7)
...
# save
ft.clean = paste(dir, "acpa_plasma_stats_clean_v2.csv", sep = "")
write.csv(file = ft.clean, stats.table.clean)
